...
@if(!empty($tvshows) && $current_page == 1 && empty($search_query) && $selected_genre == 0)
    <section class="hero-section"
        style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.8) 100%), url('https://image.tmdb.org/t/p/original{{ $tvshows[0]['backdrop_path'];  }}')">
        <div class="hero-content">
            <h2 class="hero-title">{{ htmlspecialchars($tvshows[0]['name']);  }}</h2>
            <p class="hero-description">{{ htmlspecialchars(substr($tvshows[0]['overview'], 0, 200)) . '...';  }}</p>
            <div class="hero-buttons">
                <button class="btn-play" onclick="window.location.href='play.php?id={{ $tvshows[0]['id'];  }}&type=tv&season=1&episode=1'">
...
<div class="main-layout">
    ...
    <main class="main-content">
        ...
        <div class="movie-grid" id="tvGrid">
            ...
            ?>
                <div class="movie-card" 
                     ...
                     data-rating="{{ $show['vote_average'];  }}"
                     data-year="{{ $year;  }}"
                     data-watchlist="<?php echo $inWatchlist ? '1' : '0'; ?>">
                    <div class="card-poster">
                        <img src="{{ $poster;  }}" alt="{{ htmlspecialchars($show['name']);  }}" 
                             loading="lazy"
                             onerror="this.src='https://via.placeholder.com/500x750?text=No+Image'">
                        <div class="card-overlay">
                            <button class="play-icon" title="Play" onclick="window.location.href='play.php?id={{ $show['id'];  }}&type=tv&season=1&episode=1'">
                    ...
                    <div class="card-footer">
                        ...
                        <p class="movie-title">{{ htmlspecialchars($show['name']);  }}</p>
        ...
        @if(!empty($tvshows) && $total_pages > 1)
