...
<div class="play-page-container">
                ...
                <div class="episode-grid" id="episodeGrid">
                    ...
                    ?>
                        <div class="episode-item <?php echo $episode == $e ? 'active' : ''; ?>" 
                             onclick="changeEpisodeDirect({{ $e }})">
                            <span class="episode-number">{{ $e }}</span>
        ...
        <div class="info-details">
            <div class="movie-title-row">
                ...
                <button class="watchlist-btn <?php echo $inWatchlist ? 'in-list' : ''; ?>"
                        id="watchlistBtn"
                        onclick="toggleWatchlist({{ $movie_id }})">
    ...
    <div class="rec-grid">
        <?php foreach ($recommendations as $rec):
                ...
                $rec_id = $rec['id'];
        ?>
            <div class="rec-card" onclick="location.href='play.php?id={{ $rec_id }}&type={{ $rec_type }}&server=1'">
