...
<?php if (!empty($movies) && $current_page == 1 && empty($search_query) && $selected_genre == 0): ?>
    <section class="hero-section"
        style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.8) 100%), url('https://image.tmdb.org/t/p/original<?php echo $movies[0]['backdrop_path']; ?>')">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <button class="btn-play" onclick="window.location.href='play.php?id=<?php echo $movies[0]['id']; ?>'"><i class="fas fa-play"></i> Play</button>
            </div>
        </div>
    </section>
<?php endif; ?>
                ...
                <div class="movie-card" 
                    ...
                    <div class="card-poster">
                        ...
                        <div class="card-overlay">
                            <button class="play-icon" title="Play" onclick="window.location.href='play.php?id=<?php echo $movie['id']; ?>'"><i class="fas fa-play"></i></button>
